...
export async function planTimeFit(input: PlanInput): Promise<PlanResult> {
  ...
  for (const { place, dwell: d } of listBusanPoiCandidates()) {
    ...
    const spot: Spot = {
      ...
      shortStayType: d.shortStayType,
      minStayMin: d.minStayMin,
      recommendedStayMin: d.recommendedStayMin,
      maxStayMin: d.maxStayMin,
      selectionStatus: d.selectionStatus,
      availabilityNotice: d.availabilityNotice,
